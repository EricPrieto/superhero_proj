Superheroes is a web app for superhero fans that focuses on the create, read, update, and delete (CRUD) functions.  The project was created with Python and Django and links to MySQL database.
